...
void atScene::Setup()
{
	...
	mProgramID = Utility::atLoadShaders("../Common/Shaders/StandardShading.vs", "../Common/Shaders/StandardShading.fs");
	...
	// Load the texture
	GLuint Texture = texLoader->loadBMP_custom("../data/EggData/EggColors_24Bit.bmp");//  loadDDS("uvmap.DDS");
...
void atScene::Draw(Matrix4f& viewMatrix , Matrix4f& projectionMatrix)
{
	...
	Vector3f lightPos(currentModeMat(0,3), currentModeMat(1,3) + 15 ,9);
